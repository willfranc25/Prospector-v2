...
('followers_seed', 'Followers de semillas', 'Extrae seguidores de clientes confirmados', 'daily', 10, '{"actorId":"scraping_solutions~instagram-scraper-followers-following-no-cookies","resultsLimit":500}'),
('following_seed', 'Following de semillas', 'Extrae a quién siguen los clientes confirmados', 'weekly', 8, '{"actorId":"scraping_solutions~instagram-scraper-followers-following-no-cookies","resultsLimit":200}'),
...
('apify', '{"token":"","followerActorId":"scraping_solutions~instagram-scraper-followers-following-no-cookies","profileActorId":"dSCLg0C3YEZ83HzYX","defaultLimit":500}'),
